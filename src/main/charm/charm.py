...
class SpringMusicCharm(CharmBase):
    ...
    def _update_and_restart_spring_music(self):
        ...
        if len(self.model.relations["logging"]) and self.loki_consumer.loki_push_api:
            environment["LOKI_PUSH_API_URL"] = self.loki_consumer.loki_push_api
            ...
            environment["LOKI_PUSH_API_URL"] = None
            environment["SPRING_PROFILES_ACTIVE"] = "production"

        logger.debug(f"Setting Loki Push API URL to: {self.loki_consumer.loki_push_api}")
